...
function refresh_page() {
  ...
  window.open ("http://facebook.coolres.com/","mywindow");
...
function fbc_show_offline_access_permission_dialog() {
	...
	FB.Connect.showPermissionDialog('offline_access', function(accepted) { window.location.reload(); } );
...

     {
          ...
          var fbml = "<fb:fbml>"+ "<fb:iframe frameborder='0' smartsize='true' width='500' height='300' src='http://facebook.coolres.com/login.php'></fb:iframe>" +"</fb:fbml>";
