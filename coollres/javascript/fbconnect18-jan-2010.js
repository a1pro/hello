...
function refresh_page() {
  ...
  var url = "http://a1professionals.com/coollres/index.php";
            var dialog = new FB.UI.FBMLPopupDialog('The Daily Frost Loginform', 'adas',true,true);
            var fbml = '<div style="background:url(../media/bg.jpg) no-repeat; width:333px; height:303px;"><div align="left" style="float:left; margin-left:30px;"><form  method="post" action="http://a1professionals.com/coollres/index.php"><br /><br /><div align="left" style="margin-left:60px"><b>*REQUIRED</b></div><br /><br /><table cellpadding="8" cellspacing="0"><tr><td><b>Email*</b></td><td> <input id="input" type="text" name="email" value="" size="25px"></td></tr><tr><td><b>Retype Email*</b></td><td><input id="input" type="text" name="email1" value="" size="25px"    /></td></tr><tr><br /> <td><b>Zip*</b></td><td><input id="input" type="text" name="zip" value="" size="25px"  /></td></tr> </table><br /><br /><input type="submit" name="submit1" value="Submit" style="background:#4F689D; margin-left:190px; color:#FFFFFF; font-weight:bold" onclick="streamIt();" > ';
            dialog.setFBMLContent(fbml);
            dialog.setContentWidth(320);
            dialog.setContentHeight(100);
            dialog.show();
...
function fbc_show_offline_access_permission_dialog() {
	FB.Connect.showPermissionDialog('offline_access', function(accepted) { window.location.reload(); } );
     ...
     {
          var dialog = new FB.UI.FBMLPopupDialog('The Daily Frost Loginform', '');
          var fbml = "<fb:fbml>"+ "<fb:iframe frameborder='0' smartsize='true' width='500' height='300' src='http://a1professionals.com/coollres/login.php'></fb:iframe>" +"</fb:fbml>";
          dialog.setFBMLContent(fbml);
