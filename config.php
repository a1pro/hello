...
define(CONNECT_APPLICATION_PATH, "/home/a1pro/public_html/sober_cake/");

define(CONNECT_JAVASCRIPT_PATH, "http://174.122.72.130/~a1pro/sober_cake/javascript/");

define(CONNECT_CSS_PATH, "http://174.122.72.130/~a1pro/sober_cake/css/");

define(CONNECT_IMG_PATH, "/home/a1pro/public_html/sober_cake/");
...
$callback_url    = 'http://174.122.72.130/~a1pro/sober_cake/';
...
$sample_post_url = "http://174.122.72.130/~a1pro/sober_cake/";

$sample_one_line_story = '{*actor*} posted a comment on <a href="{*post-url*}">{*post-title*}</a> and said {*post*}.';

$sample_template_data = '{"post-url":"http://174.122.72.130/~a1pro/sober_cake/", "post-title":"FB Connect Demo", "post":"This is so easy to use!"}';
